...
async def generate_image(
    ...
    try:
        ...
        # 定义不同艺术风格的转换
        style_prompts = {
            "oil_painting": "将图片转换为莫奈印象派油画风格，标志性的破碎笔触，朦胧的光影效果，柔和的色彩过渡，如同莫奈的睡莲般梦幻，厚涂技法，可见的画布纹理，捕捉瞬间光感",
            ...
            "pencil_sketch": "将图片转换为精细铅笔素描，逼真的铅笔笔触，细腻的阴影和纹理，黑白灰调，专业素描本效果，艺术家手绘质感",
            "cyberpunk": "将图片转换为赛博朋克风格，霓虹灯光效果，未来科技感，电子蓝紫色调，全息投影质感，黑暗都市背景，数字艺术美学",
            "renaissance": "将图片转换为文艺复兴肖像画风格，古典油画技法，贵族气质，达芬奇和拉斐尔式的细腻，金色装饰，皇室肖像效果",
            "mosaic": "将图片转换为马赛克艺术风格，彩色玻璃片效果，几何图案组合，拜占庭艺术风格，闪亮的镶嵌质感，教堂彩窗艺术",
            "monet_impressionist": "将图片转换为莫奈印象派风格，如睡莲系列的标志性破碎笔触，梦幻大气效果，柔和的漫射光线，可见的画布纹理，厚涂技法，闪烁的色彩过渡，捕捉光的瞬间，朦胧的梦幻品质"
        }
        ...
        if result["success"]:
            ...
            style_names = {
                ...
                "photography": "复古摄影风格",
                "minimalist": "现代简约风格",
                "pencil_sketch": "铅笔素描风格",
                "cyberpunk": "赛博朋克风格",
                "renaissance": "文艺复兴风格",
                "mosaic": "马赛克艺术风格",
                "monet_impressionist": "莫奈印象派风格"
            }
